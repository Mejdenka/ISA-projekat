...
public class PregledDTO {
    ...
    public PregledDTO(Pregled pregled){
        this(pregled.getId(),
                ...
                new LekarDTO(pregled.getLekar().getId(), pregled.getLekar().getKorisnickoIme(), pregled.getLekar().getIme(), pregled.getLekar().getPrezime(), pregled.getLekar().getDatumRodjenja(), pregled.getLekar().getEmail(), pregled.getLekar().getOcena(), pregled.getLekar().isSlobodan())
                );
    }
